...
console.log("CHECK ENV VARS", {env: process.env})
...
const main = async () => {
  ...
  // const migrations: Migration[] | undefined = atConnection ?  await atConnection.runMigrations() : undefined;

  // console.log("VIEW MIGRATIONS", {migrations}) 
